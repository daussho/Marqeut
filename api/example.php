...
try {
	...
	$client = new WC_API_Client( 'http://localhost/wp', 'ck_252e1db8081052e7ddbea2cd720bc746e7404608', 'cs_b4650067069c883a9d44e5813d6cc8034899f2cb', $options );
	
	$customer_id = $client->customers->get_by_email( '18215007@std.stei.itb.ac.id' )->customer->id;
	$order_id = $client->customers->get( $customer_id )->customer->last_order_id;
	...
	//print_r( $client->customers->get_by_email( '18215007@std.stei.itb.ac.id' ) );
	...
	//print_r( $client->orders->get( 50 ) );
	print_r( $client->orders->update_status( $order_id, 'completed' ) );
